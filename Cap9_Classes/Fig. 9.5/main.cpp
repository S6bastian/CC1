...
#include <iostream>
#include <stdexcept>
#include "Time.h" //include definition of classs Time from Time.h
using namespace std;

//displays a TIme in 24-our and 12-hour formats
...
int main(){
    ...
    Time t3{21,34}; //hour and minute specified; second defalted
    ...
    displayTime("t3: hour and minute specified; second defalted",t3);
